...
export const INI_FIELD_GROUPS: IniFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { section: "gus", iniSection: "ServerSettings", key: "RCONEnabled", label: "RCON Enabled", type: "boolean", defaultValue: true, description: "Enable the RCON remote console interface." },
      ...
      { section: "gus", iniSection: "ServerSettings", key: "AdminLogging", label: "Admin Logging", type: "boolean", defaultValue: false, description: "Log all admin commands to in-game chat (visible to admins only)." },
    ],
  },
  {
    id: "rates",
  ...
  },
  {
    ...
    fields: [
      ...
      { section: "gus", iniSection: "ServerSettings", key: "AllowAnyoneBabyImprintCuddle", label: "Anyone Can Imprint", type: "boolean", defaultValue: false, description: "Allow any player (not just the imprinter) to cuddle babies." },
    ],
  },
  {
    id: "player_dino",
    ...
    fields: [
      ...
      { section: "gus", iniSection: "ServerSettings", key: "PlayerCharacterFoodDrainMultiplier", label: "Food Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly player hunger drains. Higher = faster starvation." },
      { section: "gus", iniSection: "ServerSettings", key: "PlayerCharacterWaterDrainMultiplier", label: "Water Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly player thirst drains. Higher = faster dehydration." },
      { section: "gus", iniSection: "ServerSettings", key: "PlayerCharacterStaminaDrainMultiplier", label: "Stamina Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly player stamina depletes during sprinting, swimming, etc. Higher = faster drain." },
      { section: "gus", iniSection: "ServerSettings", key: "PlayerCharacterHealthRecoveryMultiplier", label: "Player Health Regen", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Rate at which players passively regenerate health." },
      { section: "gus", iniSection: "ServerSettings", key: "DinoCharacterFoodDrainMultiplier", label: "Dino Food Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly tamed and wild dino food stat drains. Higher = dinos need feeding more often." },
      { section: "gus", iniSection: "ServerSettings", key: "DinoCharacterStaminaDrainMultiplier", label: "Dino Stamina Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly dino stamina depletes during actions. Higher = faster drain." },
      { section: "gus", iniSection: "ServerSettings", key: "DinoCharacterHealthRecoveryMultiplier", label: "Dino Health Regen", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Rate at which dinos passively regenerate health." },
    ],
  },
  {
    id: "pvp_pve",
    ...
    fields: [
      { section: "gus", iniSection: "ServerSettings", key: "AllowPvP", label: "Allow PvP", type: "boolean", defaultValue: false, description: "Enable player-vs-player combat." },
      { section: "gus", iniSection: "ServerSettings", key: "EnablePvPGamma", label: "PvP Gamma", type: "boolean", defaultValue: false, description: "Allow gamma adjustment in PvP (gives night vision advantage)." },
      { section: "gus", iniSection: "ServerSettings", key: "PreventOfflinePvP", label: "Offline Raid Protection", type: "boolean", defaultValue: false, description: "Protect structures/tames when the owner tribe is offline." },
      ...
      { section: "gus", iniSection: "ServerSettings", key: "AllowCaveBuildingPvE", label: "Cave Building (PvE)", type: "boolean", defaultValue: false, description: "Allow structure placement inside caves in PvE mode." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowCaveBuildingPvP", label: "Cave Building (PvP)", type: "boolean", defaultValue: true, description: "Allow structure placement inside caves in PvP mode." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowFlyerCarryPvE", label: "Flyer Carry (PvE)", type: "boolean", defaultValue: false, description: "Allow flyers to pick up wild dinos and players in PvE." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowMultipleAttachedC4", label: "Multiple C4 on Tames", type: "boolean", defaultValue: false, description: "Allow attaching multiple C4 charges to a single tame." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowRaidDinoFeeding", label: "Titanosaur Feeding", type: "boolean", defaultValue: false, description: "Allow players to feed Titanosaurs to keep them tamed." },
    ],
  },
  {
    id: "tribe",
    ...
    fields: [
      ...
      { section: "gus", iniSection: "ServerSettings", key: "TribeNameChangeCooldown", label: "Tribe Rename Cooldown (min)", type: "number", min: 0, max: 1440, defaultValue: 15, description: "Minutes before a tribe can rename itself again. 0 = no cooldown." },
      { section: "gus", iniSection: "ServerSettings", key: "StructureDamageMultiplier", label: "Structure Damage", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Scales all damage dealt to player-built structures." },
      ...
      { section: "gus", iniSection: "ServerSettings", key: "PvEStructureDecayPeriodMultiplier", label: "PvE Decay Multiplier", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Multiplier on the PvE decay period. Higher = structures last longer before auto-decay." },
  ...
  },
  {
    ...
    fields: [
      ...
      { section: "gus", iniSection: "ServerSettings", key: "DayTimeSpeedScale", label: "Daytime Speed", type: "number", min: 0.1, max: 10, step: 0.1, defaultValue: 1.0, description: "Higher = daytime passes faster. Independent of the night speed scale." },
      ...
      { section: "gus", iniSection: "ServerSettings", key: "GlobalItemDecompositionTimeMultiplier", label: "Item Decay Time", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How long dropped items persist on the ground before disappearing. Higher = longer." },
      { section: "gus", iniSection: "ServerSettings", key: "GlobalCorpseDecompositionTimeMultiplier", label: "Corpse Decay Time", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How long player and wild dino corpses persist before disappearing. Higher = longer." },
  ...
  },
  {
    ...
    title: "Misc Settings",
    fields: [
      { section: "gus", iniSection: "ServerSettings", key: "ServerCrosshair", label: "Server Crosshair", type: "boolean", defaultValue: true, description: "Show the aiming crosshair for all players. Disabling it is common on RP or hardcore servers." },
      { section: "gus", iniSection: "ServerSettings", key: "ShowFloatingDamageText", label: "Show Damage Numbers", type: "boolean", defaultValue: false, description: "Show floating damage numbers above targets." },
      { section: "gus", iniSection: "ServerSettings", key: "ShowMapPlayerLocation", label: "Show Player Location", type: "boolean", defaultValue: true, description: "Show each player's location on the map." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowThirdPersonPlayer", label: "Third Person Camera", type: "boolean", defaultValue: true, description: "Allow players to switch to third-person view." },
      { section: "gus", iniSection: "ServerSettings", key: "AlwaysNotifyPlayerJoined", label: "Notify Player Joined", type: "boolean", defaultValue: false, description: "Broadcast a chat message to all players when someone joins the server." },
      { section: "gus", iniSection: "ServerSettings", key: "AlwaysNotifyPlayerLeft", label: "Notify Player Left", type: "boolean", defaultValue: false, description: "Broadcast a chat message to all players when someone leaves the server." },
      { section: "gus", iniSection: "ServerSettings", key: "GlobalVoiceChat", label: "Global Voice Chat", type: "boolean", defaultValue: false, description: "All voice chat is heard server-wide instead of just nearby players." },
      { section: "gus", iniSection: "ServerSettings", key: "ProximityChat", label: "Proximity Chat Only", type: "boolean", defaultValue: false, description: "Text chat is only visible to players nearby. Disables global text chat." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowHitMarkers", label: "Hit Markers", type: "boolean", defaultValue: true, description: "Show on-screen indicators when you successfully hit a target." },
      { section: "gus", iniSection: "ServerSettings", key: "ClampItemStats", label: "Clamp Item Stats", type: "boolean", defaultValue: false, description: "Prevent items from having stats above official limits." },
      { section: "gus", iniSection: "ServerSettings", key: "DisableWeatherFog", label: "Disable Weather Fog", type: "boolean", defaultValue: false, description: "Disables foggy weather across all maps." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowFlyingStaminaRecovery", label: "Flying Stamina Recovery", type: "boolean", defaultValue: false, description: "Flyers passively recover stamina while a rider stands on them mid-flight." },
  ...
  // ── Breeding (extended) ────────────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "BabyFoodConsumptionSpeedMultiplier", label: "Baby Food Drain", type: "number", min: 0.01, max: 20, step: 0.25, defaultValue: 12.0, description: "Lower value = babies eat less frequently. Must reduce when using high BabyMatureSpeedMultiplier to prevent starvation." },
  ...
  // ── Player & Dino (extended) ───────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "gus", iniSection: "ServerSettings", key: "TamedDinoDamageMultiplier", label: "Tamed Dino Damage", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Scales damage output of tamed dinos. Stacks with the general Dino Damage multiplier." },
      ...
      { section: "gus", iniSection: "ServerSettings", key: "FishingLootQualityMultiplier", label: "Fishing Loot Quality", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Scales the quality (e.g. Journeyman, Mastercraft) of items caught via fishing." },
      { section: "gus", iniSection: "ServerSettings", key: "SupplyCrateLootQualityMultiplier", label: "Supply Crate Loot Quality", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "Scales the quality of items inside supply drops and orbital supply crates." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "DinoHarvestingDamageMultiplier", label: "Dino Harvesting Damage", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 3.2, description: "Damage dinos deal to harvestable resources." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "TamedDinoCharacterFoodDrainMultiplier", label: "Tamed Dino Food Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly tamed dinos deplete their food stat. Higher = need feeding more often." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "TamedDinoTorporDrainMultiplier", label: "Tamed Dino Torpor Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly torpor drains from tamed dinos after being knocked out. Higher = shorter KO time." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "WildDinoCharacterFoodDrainMultiplier", label: "Wild Dino Food Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly wild dino food stat drains. Affects how fast they eat kibble/meat during taming." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "WildDinoTorporDrainMultiplier", label: "Wild Dino Torpor Drain", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly wild dino torpor drains during taming. Lower = more forgiving tames." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "HairGrowthSpeedMultiplier", label: "Hair Growth Speed", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How quickly player and creature hair grows. Higher = faster growth to full length." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "GlobalCorpseDecompositionTimeMultiplier", label: "Corpse Decomposition Time", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 1.0, description: "How long corpses persist in the game world before disappearing. Higher = longer." },
  ...
  // ── XP Multipliers ────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "KillXPMultiplier", label: "Kill XP", type: "number", min: 0, max: 100, step: 0.1, defaultValue: 1.0, description: "Scales XP earned from killing creatures and players." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "HarvestXPMultiplier", label: "Harvest XP", type: "number", min: 0, max: 100, step: 0.1, defaultValue: 1.0, description: "Scales XP earned from harvesting resources." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "CraftXPMultiplier", label: "Craft XP", type: "number", min: 0, max: 100, step: 0.1, defaultValue: 1.0, description: "Scales XP earned from crafting items." },
  ...
  // ── PvP Settings (Game.ini) ────────────────────────────────────────────────
  {
    ...
    title: "PvP (Advanced)",
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bIncreasePvPRespawnInterval", label: "Increase Respawn on Repeat Deaths", type: "boolean", defaultValue: true, description: "Adds a respawn time penalty when the same player is killed repeatedly in a short window." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "IncreasePvPRespawnIntervalMultiplier", label: "Respawn Penalty Multiplier", type: "number", min: 0, max: 10, step: 0.1, defaultValue: 2.0, description: "Each repeat kill within the penalty window multiplies the added respawn time by this value." },
  ...
  // ── PvE Settings (Game.ini) ────────────────────────────────────────────────
  {
    ...
    title: "PvE (Game.ini)",
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bDisableFriendlyFire", label: "Disable Friendly Fire", type: "boolean", defaultValue: false, description: "Required for PvE — prevents players and tamed dinos from damaging allies." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bPvEDisableFriendlyFire", label: "Disable Friendly Fire (PvE Context)", type: "boolean", defaultValue: false, description: "Companion to Disable Friendly Fire for PvE-specific code paths. Enable both for full PvE." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bPvEAllowTribeWar", label: "Allow Tribe Wars in PvE", type: "boolean", defaultValue: true, description: "Allows tribes in PvE to mutually declare war, enabling temporary PvP between them." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bPvEAllowTribeWarCancel", label: "Allow Tribe War Cancellation", type: "boolean", defaultValue: false, description: "Allows tribes to cancel a declared war before it begins." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAutoPvETimer", label: "Auto PvE Timer", type: "boolean", defaultValue: false, description: "Enables automatic scheduled PvP→PvE switching based on time of day." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAutoPvEUseSystemTime", label: "Auto PvE Use System Time", type: "boolean", defaultValue: false, description: "When true, the Auto PvE timer uses the server's local wall-clock time. When false, uses in-game day/night time." },
  ...
  // ── Leveling & Respecs ────────────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowUnlimitedRespecs", label: "Unlimited Respecs", type: "boolean", defaultValue: false, description: "Removes the 24-hour cooldown on Mindwipe Tonic. Players can respec freely." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowFlyerSpeedLeveling", label: "Flyer Speed Leveling", type: "boolean", defaultValue: false, description: "Allow flyers to have their speed stat leveled up." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowSpeedLeveling", label: "Creature Speed Leveling", type: "boolean", defaultValue: false, description: "Allow all creatures (not just flyers) to level movement speed." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bUseSingleplayerSettings", label: "Use Singleplayer Settings", type: "boolean", defaultValue: false, description: "Applies singleplayer difficulty and stat scaling to a multiplayer server." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bShowCreativeMode", label: "Show Creative Mode", type: "boolean", defaultValue: false, description: "Enables Creative Mode in the inventory screen." },
    ],
  },
  // ── Engrams ───────────────────────────────────────────────────────────────
  {
    ...
    title: "Engrams",
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAutoUnlockAllEngrams", label: "Auto Unlock All Engrams", type: "boolean", defaultValue: false, description: "All engrams are automatically unlocked for all players. Players still need the required level." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bOnlyAllowSpecifiedEngrams", label: "Only Allow Specified Engrams", type: "boolean", defaultValue: false, description: "Only engrams listed in EngramEntryAutoUnlocks are available. All others are hidden." },
    ],
  },
  // ── Custom Recipes ────────────────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowCustomRecipes", label: "Allow Custom Recipes", type: "boolean", defaultValue: true, description: "Enables the custom recipe system — players can create named food/consumable recipes." },
  ...
  // ── Platform Saddles ──────────────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowPlatformSaddleMultiFloors", label: "Platform Saddle Multi-Floor", type: "boolean", defaultValue: false, description: "Allows building multiple stacked floors on platform saddles." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bFlyerPlatformAllowUnalignedDinoBasing", label: "Flyer Platform Unaligned Dino Basing", type: "boolean", defaultValue: false, description: "Allows dinos to stand on flyer platform saddles regardless of alignment." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bIgnoreStructuresPreventionVolumes", label: "Ignore Build Prevention Volumes", type: "boolean", defaultValue: false, description: "Allows building in areas that would otherwise block structures (e.g., artifact caves, obelisk platforms)." },
    ],
  },
  // ── Dino Control ─────────────────────────────────────────────────────────
  {
    ...
    title: "Dino Control",
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bDisableDinoTaming", label: "Disable Taming", type: "boolean", defaultValue: false, description: "Prevents all dino taming." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bDisableDinoBreeding", label: "Disable Breeding", type: "boolean", defaultValue: false, description: "Prevents all dino breeding and egg hatching." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bDisableDinoRiding", label: "Disable Riding", type: "boolean", defaultValue: false, description: "Prevents players from riding tamed dinos." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bAllowUnclaimDinos", label: "Allow Unclaim Dinos", type: "boolean", defaultValue: true, description: "Allows tribe members to unclaim (release ownership of) their tamed dinos." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bUseTameLimitForStructuresOnly", label: "Tame Limit for Structures Only", type: "boolean", defaultValue: false, description: "When true, the tame cap only applies to dinos used as structure foundations (rafts etc.) — not general tames." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bUseDinoLevelUpAnimations", label: "Dino Level Up Animations", type: "boolean", defaultValue: true, description: "Shows the level-up visual effect when a tamed dino gains a level." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bPassiveDefensesDamageRiderlessDinos", label: "Passive Defenses Damage Riderless Dinos", type: "boolean", defaultValue: false, description: "Plant species X and other passive defenses deal damage to tamed dinos that have no rider." },
    ],
  },
  // ── Resource Management ───────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bDisableLootCrates", label: "Disable Supply Drops", type: "boolean", defaultValue: false, description: "Prevents supply drops (orbital supply drops / beacons) from spawning." },
    ],
  },
  // ── Turret & Defense Limits ───────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bLimitTurretsInRange", label: "Enable Turret Limit", type: "boolean", defaultValue: true, description: "Enables the turret count limit per radius. Recommended on all servers to prevent performance degradation." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "bHardLimitTurretsInRange", label: "Hard Turret Limit", type: "boolean", defaultValue: false, description: "When true, prevents placing turrets that would exceed the limit. When false, only issues a warning." },
  ...
  // ── Tribe Settings ────────────────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "MaxAlliancesPerTribe", label: "Max Alliances Per Tribe", type: "number", min: 0, max: 100, defaultValue: 0, description: "Maximum number of alliances a tribe can belong to. 0 = unlimited (game default)." },
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "MaxTribesPerAlliance", label: "Max Tribes Per Alliance", type: "number", min: 0, max: 100, defaultValue: 0, description: "Maximum number of tribes in a single alliance. 0 = unlimited (game default)." },
      ...
      { section: "game", iniSection: "/script/shootergame.shootergamemode", key: "MaxTribeLogs", label: "Max Tribe Log Entries", type: "number", min: 100, max: 10000, step: 100, defaultValue: 400, description: "How many entries to keep in the tribe log." },
  ...
  // ── Decay & Cleanup ───────────────────────────────────────────────────────
  {
    ...
    title: "Decay & Cleanup",
    fields: [
      { section: "gus", iniSection: "ServerSettings", key: "DisableStructureDecayPvE", label: "Disable Structure Decay (PvE)", type: "boolean", defaultValue: false, description: "Structures never decay in PvE mode. Removes maintenance pressure for casual servers." },
      { section: "gus", iniSection: "ServerSettings", key: "DisableDinoDecayPvE", label: "Disable Dino Decay (PvE)", type: "boolean", defaultValue: false, description: "Tamed dinos never become unclaim-eligible in PvE. Prevents accidental loss." },
      { section: "gus", iniSection: "ServerSettings", key: "OnlyAutoDestroyCoreStructures", label: "Only Auto-Destroy Core Structures", type: "boolean", defaultValue: false, description: "Only lone foundations and pillars decay on their own. Walls and ceilings connected to a decaying foundation collapse when it does." },
      { section: "gus", iniSection: "ServerSettings", key: "AutoDestroyDecayedDinos", label: "Auto-Destroy Decayed Dinos", type: "boolean", defaultValue: false, description: "Decayed tames are automatically removed when the server loads, instead of sitting as claimable dinos." },
  ...
  // ── Structure Pickup & Locking ────────────────────────────────────────────
  {
    ...
    fields: [
      { section: "gus", iniSection: "ServerSettings", key: "ForceAllStructureLocking", label: "Force All Structures Locked", type: "boolean", defaultValue: false, description: "All newly placed structures default to locked. Players must manually unlock." },
      { section: "gus", iniSection: "ServerSettings", key: "AlwaysAllowStructurePickup", label: "Always Allow Structure Pickup", type: "boolean", defaultValue: false, description: "Remove the 30-second pickup timer. Structures can be picked up at any time." },
      { section: "gus", iniSection: "ServerSettings", key: "PvEAllowStructuresAtSupplyDrops", label: "Build Near Supply Drops (PvE)", type: "boolean", defaultValue: false, description: "Allow structures to be placed near orbital supply drops in PvE." },
      { section: "gus", iniSection: "ServerSettings", key: "AllowCrateSpawnsOnTopOfStructures", label: "Supply Drops Land on Structures", type: "boolean", defaultValue: false, description: "Supply drops will land on top of structures instead of being blocked by them." },
      { section: "gus", iniSection: "ServerSettings", key: "bDisableStructurePlacementCollision", label: "Disable Structure Placement Collision", type: "boolean", defaultValue: false, description: "Allows structures to be placed overlapping other structures or terrain (creative-mode building)." },
    ],
  },
  ...
  // ── Ragnarok ─────────────────────────────────────────────────────────────
  {
    ...
    title: "Ragnarok",
    fields: [
      { section: "gus", iniSection: "Ragnarok", key: "AllowMultipleTamedUnicorns", label: "Multiple Tamed Unicorns", type: "boolean", defaultValue: false, description: "Allows more than one tamed Unicorn per server. By default only one wild Unicorn can be tamed at a time; a new wild one won't spawn until the interval elapses." },
      { section: "gus", iniSection: "Ragnarok", key: "UnicornSpawnInterval", label: "Unicorn Respawn Interval (hours)", type: "number", min: 1, max: 720, step: 1, defaultValue: 24, description: "Minimum hours before a new wild Unicorn spawns after the previous one was tamed or killed. The actual wait is randomly between 1× and 2× this value." },
      { section: "gus", iniSection: "Ragnarok", key: "BossSpawnInterval", label: "Boss Spawn Interval (hours)", type: "number", min: 1, max: 720, step: 1, defaultValue: 24, description: "Hours between Dragon and Manticore boss arena event spawns on Ragnarok." },
      { section: "gus", iniSection: "Ragnarok", key: "EnableVolcano", label: "Enable Volcano", type: "boolean", defaultValue: true, description: "Enables the Ragnarok volcano eruption events. When disabled the volcano is permanently dormant." },
      { section: "gus", iniSection: "Ragnarok", key: "VolcanoIntensity", label: "Volcano Intensity", type: "number", min: 0.25, max: 10, step: 0.05, defaultValue: 1.0, description: "Controls the intensity of eruptions — lower values are more intense, higher values reduce the flaming rocks flung out. Minimum 0.25; for multiplayer servers 0.5 is the recommended lower bound." },
      { section: "gus", iniSection: "Ragnarok", key: "VolcanoInterval", label: "Volcano Interval", type: "number", min: 0, max: 20, step: 0.1, defaultValue: 0, description: "Controls how often the volcano erupts. 0 = random between 5 000–15 000 seconds. Any value above 0 is used as a multiplier on that range (minimum effective multiplier 0.1)." },
    ],
  },
